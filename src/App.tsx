...
const backgroundMusic = "/paulyudin-wedding-485932.mp3";
...
const brideGroomImage = "/images/full suite.webp";
...
function CountdownTimer() {
  const targetDate = new Date("July 15, 2026 08:00:00").getTime();
...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwUXahjTDmX0a5eNtQ8QIAeubAL5dsEkk6WpTZ64rbK3sHQxBM-9Fj6BLMrACpov-1M/exec";
      ...
      <AnimatePresence mode="wait">
        {!isOpened ? (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
              <div className="relative w-full h-full group">
                <video
                  ...
                  src="/Wedding_rings_interlocking_on_na…_202606110130.mp4"
                />
                {/* Colorful Frame for the strip (Hidden since it's full screen) */}
            ...
            <div className="absolute top-12 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
              <p className="font-cinzel text-[11px] tracking-[0.8em] font-bold uppercase flex flex-col items-center gap-3">
                <span className="bg-gradient-to-r from-pink-400 via-amber-400 to-sky-400 bg-clip-text text-transparent opacity-80">S & M</span>
          ...
          >
            ...
            {/* Hero Section */}
            <section 
              className="min-h-[100dvh] w-full flex items-center justify-center p-4 md:p-12 relative overflow-hidden bg-cover bg-center"
              style={{ backgroundImage: "url('/ChatGPT Image Jun 11, 2026, 01_31_37 AM.png')" }}
            >
              ...
              {/* Freely Floating Text Container */}
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1.2, delay: 0.2, ease: [0.25, 1, 0.5, 1] }}
                className="relative z-10 w-full max-w-[420px] min-h-[500px] h-[85vh] md:h-[80vh] flex flex-col items-center p-6 pt-12 md:p-10 md:pt-16"
              >
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                  ...
                  <div className="space-y-0 py-4 flex-1 flex flex-col justify-center">
                    <motion.h1
                      ...
                      className="font-playball text-[3rem] sm:text-[3.5rem] md:text-[5rem] text-white leading-[1.1] drop-shadow-md"
                    >
                      Sachini
                    </motion.h1>
                    <motion.div
                      ...
                      className="font-playball text-3xl md:text-5xl text-theme-300 italic font-light my-2 md:my-4 tracking-widest drop-shadow-md"
                    >
                      &
                    </motion.div>
                    <motion.h1
                    ...
                    >
                      {guestPrefix && guestName && (
                        <p className="font-cinzel text-lg md:text-2xl text-white tracking-widest drop-shadow-md text-center max-w-[90%] md:max-w-none">
                          We cordially invite {guestPrefix} {guestName}
                        </p>
                      )}
                      <span className="inline-block text-[10px] md:text-[13px] uppercase tracking-[0.6em] md:tracking-[0.8em] text-white font-bold px-5 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 shadow-sm">
                        Please join us
                      </span>
                    </motion.div>
                  </div>
                  ...
                  >
                    <div className="flex items-center justify-center gap-4 mb-6 opacity-70 w-full px-8">
                      <div className="h-px w-full bg-gradient-to-r from-transparent via-white to-white/50" />
                      <div className="w-1.5 h-1.5 rotate-45 bg-white shrink-0" />
                      <div className="h-px w-full bg-gradient-to-l from-transparent via-white to-white/50" />
                    </div>
                    <div className="font-cinzel space-y-1 drop-shadow-md">
            ...
            <section className="cv-auto py-24 md:py-32 w-full flex flex-col items-center px-4 relative">
              ...
              {/* New Top Left Corner Image in Original Colors */}
              <InviteImage src="/1.png" className="absolute -left-6 -top-4 w-[140px] md:w-[240px] h-auto object-contain pointer-events-none z-0" alt="" />
              {/* New Bottom Right Corner Image in Original Colors */}
              <InviteImage src="/ChatGPT_Image_Jun_11__2026__01_40_36_AM-removebg-preview.png" className="absolute -right-12 -bottom-12 w-[220px] md:w-[380px] h-auto object-contain pointer-events-none z-0" alt="" />
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center md:items-stretch gap-6 md:gap-10 my-12 md:my-20 z-10 px-2 lg:px-8">
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. & Mrs. Jayasinghe</p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Sachini</h3>
                    </div>
                  </motion.div>
                  ...
                  {/* Milan's Card - Offset structurally on desktop */}
                  <motion.div
                    initial={{ opacity: 0, x: 30, y: 20 }}
                    whileInView={{ opacity: 1, x: 0, y: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr. & Mrs. Kannangara</p>
                      </div>
                ...
                >
                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 text-center w-full max-w-5xl px-4">
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-xl md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">2026.07.15</p>
                      <p className="font-cinzel text-lg md:text-xl text-theme-600 tracking-[0.3em] font-normal mt-2">WEDNESDAY</p>
                    </div>
            ...
            {/* Countdown Section */}
            <section className="cv-auto py-24 md:py-36 bg-[#000f29] relative border-y border-theme-800 flex flex-col items-center overflow-hidden">
              ...
              <div className="w-full max-w-[1000px] px-4 flex flex-col items-center text-center relative z-10">
                ...
                >
                  {/* Watermark text */}
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-playball text-[12vw] md:text-[140px] text-white/5 whitespace-nowrap pointer-events-none z-0 select-none">
                    Forever
                  </div>

                  <div className="flex items-center gap-4 md:gap-8 justify-center relative z-10 w-full mb-6 mt-4 opacity-70">
                    <div className="h-[2px] w-16 md:w-32 bg-gradient-to-r from-transparent to-theme-300 shadow-[0_0_8px_rgba(192,192,192,0.2)]" />
                    <div className="w-2 h-2 rotate-45 bg-theme-200 shrink-0" />
                    <div className="h-[2px] w-16 md:w-32 bg-gradient-to-l from-transparent to-theme-300 shadow-[0_0_8px_rgba(192,192,192,0.2)]" />
                  </div>

                  <h2 className="font-cinzel text-3xl md:text-5xl text-white mb-8 relative z-10 tracking-widest font-bold drop-shadow-sm px-4 leading-[1.4]">
                    Wait for the <span className="font-playball text-theme-200 italic lowercase tracking-normal text-4xl md:text-7xl ml-2">magic</span>
                  </h2>

                  <p className="text-[10px] md:text-[11px] uppercase tracking-[0.5em] text-theme-100 font-bold bg-white/10 backdrop-blur-sm px-8 py-3 rounded-full border border-white/20 inline-flex items-center gap-3 shadow-[0_4px_15px_-5px_rgba(0,0,0,0.2)] relative z-10">
              ...
              <div className="container mx-auto px-4 max-w-6xl relative z-10">
                <div className="text-center mb-16 md:mb-24 flex flex-col items-center">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-theme-600 font-bold uppercase tracking-[0.4em] text-[9px] md:text-[11px]">The Venues</span>
                    <div className="w-10 h-[2px] bg-theme-500 shadow-[0_0_8px_rgba(192,192,192,0.4)]" />
                  </div>
                ...
                <div className="flex flex-col gap-16 items-center w-full max-w-2xl mx-auto">
                  ...
                  >
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4 relative pt-2">
                        ...
                        <div className="pl-6 space-y-2">
                          <p className="text-stone-700 text-sm md:text-base tracking-wide font-medium">
                            Kurunegala.
                          </p>
                    ...
                    <div className="w-full space-y-6">
                      ...
                      />
                      <button
                        onClick={() => window.open('https://www.google.com/maps/search/?api=1&query=The+Epitome+Kurunegala', '_blank')}
                        className="w-full md:w-auto flex items-center justify-center gap-4 bg-theme-800 text-white px-8 py-4 rounded-full font-bold uppercase tracking-[0.2em] text-[9px] md:text-xs hover:bg-theme-900 hover:shadow-xl hover:shadow-theme-900/20 transition-all duration-300 group cursor-pointer"
                      >
                    ...
                    <div className="relative w-full aspect-[4/3] rounded-t-[100px] rounded-b-[2rem] shadow-[0_20px_45px_-10px_rgba(0,0,0,0.12)] border-[8px] border-white bg-theme-100 overflow-hidden group">
                      ...
                      <div className="absolute inset-0 w-full h-full scale-[1.2] group-hover:scale-[1.15] transition-transform duration-[2s]">
                        <iframe
                          src="https://maps.google.com/maps?q=The+Epitome+Kurunegala&t=&z=14&ie=UTF8&iwloc=&output=embed"
                          width="100%"
                          height="100%"
                          style={{ border: 0 }}
                          allowFullScreen
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white via-white/80 to-transparent h-20 pointer-events-none z-10 flex items-end justify-center pb-4">
                        <p className="text-[7px] uppercase tracking-widest text-stone-500 font-bold bg-white/95 px-4 py-1.5 rounded-full shadow-sm backdrop-blur-md inline-flex items-center gap-1.5">
            ...
            {/* RSVP Section */}
            <section className="cv-auto py-24 md:py-36 bg-[#000f29] text-white relative overflow-hidden flex flex-col items-center">
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  ...
                  <p className="text-stone-300 text-sm md:text-base max-w-md mx-auto leading-relaxed mb-16 tracking-wide font-light">
                    We would be absolutely thrilled to celebrate with you. Kindly respond by the 15th of June.
                  </p>
                    ...
                    <form className="space-y-8 text-left" onSubmit={(e) => { e.preventDefault(); handleSubmit("rsvp", rsvpData); }}>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative">
                          ...
                          >
                            <option value="1" className="bg-[#000f29] text-white">1 Guest (Just Me)</option>
                            <option value="2" className="bg-[#000f29] text-white">2 Guests</option>
                            <option value="3" className="bg-[#000f29] text-white">3 Guests</option>
                            <option value="4" className="bg-[#000f29] text-white">4 Guests</option>
                            <option value="0" className="bg-[#000f29] text-theme-300">Regretfully Decline</option>
                          </select>
            ...
            <div className="relative bg-[#FFFFFF]">
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Sachini & Milan</h3>
              ...
              <footer className="py-20 border-t border-theme-200/30 text-center relative z-10 space-y-6">
                <p className="text-[9px] md:text-[11px] uppercase tracking-[0.5em] text-stone-500 font-bold">
                  © 2026 Sachini & Milan. All rights reserved.
                </p>
